...
serve(async (req: Request) => {
  try {
    ...
    console.log(`Looking for past_due accounts older than: ${gracePeriodCutoff.toISOString()}`);
    ...
    for (const user of users) {
      try {
        ...
        console.log(`User ${user.id} has been in past_due for ${daysInGracePeriod} days. Freezing account...`);
    ...
    console.log(`Grace period expiration scan complete. Frozen: ${frozenCount}`);
